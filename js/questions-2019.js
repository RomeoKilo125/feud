let questions = [
  {
    q: "Name something that often has magical powers in fairy tales.",
    a: [
      {
        content: "Wand",
        value: 34
    ...
    q: "Which magic trick would become dangerous if the magician was a phony?",
    a: [
      {
        content: "Person cut in half",
        value: 52
      }, {
        content: "Sword Swallow",
        value: 19
      }, {
        content: "disappearing act",
        value: 14
      }, {
        content: "knife throwing",
        value: 11
      }
    ]
  }, {
    q: "which word or phrase is often used as a magicians magic word(s)",
    a: [
      {
    ...
    q: "if there were a college for magicians, name a trick you're sure would be taught on day one.",
    a: [
      {
        content: "objects disappear",
        value: 37
      }, {
        content: "rabbit out of a hat",
        value: 25
      }, {
        content: "card tricks",
        value: 19
    ...
    q: "past or present, name a famous magician",
    a: [
      {
    ...
    q: "name a color leaves turn in autumn",
    a: [
      {
        content: "red",
        value: 27
    ...
    q: "name something bad that might happen to a magician's assistant during a performance",
    a: [
      {
        content: "cut in half",
        value: 46
        ...
        content: "get hit by a knife",
        value: 13
      }
    ]
  }, {
    q: "name a smell you associate with fall",
    a: [
      {
        content: "leaves",
        value: 46
    ...
    q: "name something a child needs to look like a princess",
    a: [
      {
        content: "tiara",
        value: 63
    ...
    q: "name a sport that is played during the fall",
    a: [
      {
        content: "football",
        value: 56
    ...
    q: "name a famous person who's last name is \"Johnson\"",
    a: [
      {
        ...
        content: "howard johnson",
        value: 7
      }, {
        content: "lady bird johnson",
        value: 5
      }
    ]
  }, {
    q: "other than an airplane, what might a cartoon character use to help them fly",
    a: [
      {
        content: "wings",
        value: 46
        ...
        content: "magic carpet",
        value: 4
      }
    ]
  }, {
    q: "if you were offered a magic carpet ride, name something you'd add to the trip more comfy",
    a: [
      {
        content: "seat/cushion",
        value: 53
      }, {
    ...
    q: "name something a magician might remove from audience members without them knowing it was gone",
    a: [
      {
        content: "money",
        value: 29
    ...
    q: "what might you name your son if you wanted him to grow up to be a magician?",
    a: [
      {
        content: "Houdini",
        value: 49
