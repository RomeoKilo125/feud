let questions = [
  {
    q: "Name a reason you might get rid of an old family heirloom.",
    a: [
      {
        content: "Broken",
        value: 29
        ...
        content: "Sell/Need Money",
        value: 12
      }, {
        content: "Too much stuff",
        value: 10
      }, {
        content: "Family feud",
        value: 5
    ...
    q: "Where do kids nowadays spend most of their time?",
    a: [
      {
        content: "Room/Bed",
        value: 28
    ...
    q: "Tell me something many people do just once a week.",
    a: [
      {
        content: "Church",
        value: 35
    ...
    q: "Name a reason a person might wake up at 2 in the morning.",
    a: [
      {
        content: "Bathroom",
        value: 24
        ...
        content: "Heard a noise",
        value: 13
      }, {
        content: "Hot/Cold",
        value: 12
      }, {
        content: "Hungry/Thirsty",
        value: 6
      }, {
        content: "Work",
        value: 4
    ...
    a: [
      {
        ...
        content: "Changed in a locker room",
        value: 3
      }, {
        content: "Tennis",
        value: 2
    ...
    q: "We asked 100 Americans: How much you tip for good service?",
    a: [
      {
        content: "20%",
        value: 39
